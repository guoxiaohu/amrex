module amrex_nborparticlecontainer_module
  ...
  ! public routines
  public :: amrex_nborparticlecontainer_build, amrex_nborparticlecontainer_destroy
 ...
 ! public :: amrex_get_next_particle_id, amrex_get_cpu
  ...
  type, public :: amrex_nborparticlecontainer
  ...
  interface
     ...
     subroutine amrex_fi_nborparticle_regrid(pc, dm, ba, lev) bind(c)
       import
       implicit none
       integer(c_int), value :: lev
       type(c_ptr),    value :: pc, dm, ba
     end subroutine amrex_fi_nborparticle_regrid

     subroutine amrex_fi_nborparticle_fillNeighbors(pc) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
     end subroutine amrex_fi_nborparticle_regrid

     subroutine amrex_fi_nborparticle_sumNeighbors(pc, real_start_comp, real_num_comp, int_start_comp, int_num_comp) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
       integer(c_int) :: real_start_comp, real_num_comp
       integer(c_int) :: int_start_comp, int_num_comp
     end subroutine amrex_fi_nborparticle_sumNeighbors

     subroutine amrex_fi_nborparticle_updateNeighbors(pc) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
     end subroutine amrex_fi_nborparticle_updateNeighbors

     subroutine amrex_fi_nborparticle_clearNeighbors(pc) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
     end subroutine amrex_fi_nborparticle_clearNeighbors


     subroutine amrex_fi_nborparticle_RedistributeLocal(pc) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
     end subroutine amrex_fi_nborparticle_RedistributeLocal
     ...
     subroutine amrex_fi_nborparticle_printNeighborList(pc) bind(c)
       import
       implicit none
       type(c_ptr),    value :: pc
     end subroutine amrex_fi_nborparticle_printNeighborList
...
end module amrex_nborparticlecontainer_module
